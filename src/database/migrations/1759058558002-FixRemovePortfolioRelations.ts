...
export class FixRemovePortfolioRelations1759058558002 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        if (constraintExists && constraintExists.length > 0) {
            ...
            `);
            console.log('Dropped FK_lease_charge_portfolio_id constraint');
        } else {
            console.log('FK_lease_charge_portfolio_id constraint does not exist, skipping drop');
        }
    }
