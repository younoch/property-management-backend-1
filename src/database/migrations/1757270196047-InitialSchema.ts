...
export class InitialSchema1757270196047 implements MigrationInterface {
    name = 'InitialSchema1757270196047'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "unit" ("id" SERIAL NOT NULL, "portfolio_id" integer NOT NULL, "property_id" integer NOT NULL, "label" character varying NOT NULL, "bedrooms" integer, "bathrooms" integer, "sqft" integer, "market_rent" numeric(12,2), "status" character varying NOT NULL DEFAULT 'vacant', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "UQ_9c25f08c1686493fe5e5d03f325" UNIQUE ("portfolio_id", "property_id", "label"), CONSTRAINT "PK_4252c4be609041e559f0c80f58a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "property" ("id" SERIAL NOT NULL, "portfolio_id" integer NOT NULL, "name" character varying NOT NULL, "address_line1" character varying, "address_line2" character varying, "city" character varying, "state" character varying, "postal_code" character varying, "country" character varying, "latitude" numeric(10,6), "longitude" numeric(10,6), "property_type" character varying NOT NULL, "description" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_d80743e6191258a5003d5843b4f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "portfolio" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "address" character varying, "city" character varying, "state" character varying, "postal_code" character varying, "country" character varying, "phone" character varying, "email" character varying, "website" character varying, "tax_id" character varying, "registration_number" character varying, "vat_number" character varying, "currency" character varying NOT NULL DEFAULT 'USD', "landlord_id" integer NOT NULL, "subscription_plan" character varying NOT NULL, "provider_customer_id" character varying NOT NULL DEFAULT '', "status" character varying NOT NULL DEFAULT 'active', "timezone" character varying NOT NULL DEFAULT 'UTC', "logo_url" character varying, "invoice_settings" jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_6936bb92ca4b7cda0ff28794e48" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "phone" character varying, "password_hash" character varying NOT NULL, "role" character varying NOT NULL, "profile_image_url" character varying, "is_active" boolean NOT NULL DEFAULT true, "requires_onboarding" boolean NOT NULL DEFAULT true, "onboarding_completed_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "lease" ("id" SERIAL NOT NULL, "portfolio_id" integer NOT NULL, "unit_id" integer NOT NULL, "start_date" date NOT NULL, "end_date" date NOT NULL, "rent" numeric(12,2) NOT NULL, "deposit" numeric(12,2) NOT NULL DEFAULT '0', "billing_day" integer, "grace_days" integer, "late_fee_flat" numeric(12,2), "late_fee_percent" numeric(5,2), "notes" text, "status" character varying NOT NULL DEFAULT 'draft', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_954811694773f24986695203663" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "lease_charge" ("id" SERIAL NOT NULL, "portfolio_id" integer NOT NULL, "lease_id" integer NOT NULL, "name" character varying NOT NULL, "unit_id" integer NOT NULL, "property_id" integer NOT NULL, "amount" numeric(12,2) NOT NULL, "cadence" character varying NOT NULL DEFAULT 'monthly', "start_date" date NOT NULL, "end_date" date, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_09772a7297c9b7a7e1300be76ba" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "payment" ("id" SERIAL NOT NULL, "portfolio_id" integer NOT NULL, "lease_id" integer NOT NULL, "amount" numeric(12,2) NOT NULL, "unapplied_amount" numeric(12,2) NOT NULL DEFAULT '0', "method" "public"."payment_method_enum" NOT NULL DEFAULT 'cash', "at" date NOT NULL, "reference" character varying, "notes" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_fcaec7df5adf9cac408c686b2ab" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "payment_application" ("id" SERIAL NOT NULL, "payment_id" integer NOT NULL, "invoice_id" integer NOT NULL, "amount" numeric(12,2) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c5ef59ca781f304514e37deddb7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "invoices" ("id" SERIAL NOT NULL, "portfolio_id" integer NOT NULL, "lease_id" integer, "invoice_number" character varying(50) NOT NULL, "issue_date" date NOT NULL DEFAULT ('now'::text)::date, "due_date" date, "grace_days" integer NOT NULL DEFAULT '0', "subtotal" numeric(12,2) NOT NULL DEFAULT '0', "tax_amount" numeric(12,2) NOT NULL DEFAULT '0', "total_amount" numeric(12,2) NOT NULL DEFAULT '0', "amount_paid" numeric(12,2) NOT NULL DEFAULT '0', "balance_due" numeric(12,2) NOT NULL DEFAULT '0', "period_start" date NOT NULL, "billing_month" character varying(7) NOT NULL DEFAULT to_char(CURRENT_DATE, 'YYYY-MM'), "period_end" date NOT NULL, "status" character varying(20) NOT NULL DEFAULT 'draft', "notes" text, "terms" text, "sent_at" TIMESTAMP WITH TIME ZONE, "paid_at" TIMESTAMP, "voided_at" TIMESTAMP, "metadata" jsonb, "is_issued" boolean NOT NULL DEFAULT false, "items" jsonb NOT NULL DEFAULT '[]'::jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "UQ_d8f8d3788694e1b3f96c42c36fb" UNIQUE ("invoice_number"), CONSTRAINT "PK_668cef7c22a427fd822cc1be3ce" PRIMARY KEY ("id")); COMMENT ON COLUMN "invoices"."invoice_number" IS 'Unique invoice number'; COMMENT ON COLUMN "invoices"."issue_date" IS 'Date when the invoice was created/issued'; COMMENT ON COLUMN "invoices"."due_date" IS 'Due date for payment, calculated based on issue_date + payment_terms'; COMMENT ON COLUMN "invoices"."grace_days" IS 'Grace period in days after due date before late fees apply'; COMMENT ON COLUMN "invoices"."subtotal" IS 'Subtotal amount before tax'; COMMENT ON COLUMN "invoices"."tax_amount" IS 'Total tax amount'; COMMENT ON COLUMN "invoices"."total_amount" IS 'Total amount including tax'; COMMENT ON COLUMN "invoices"."amount_paid" IS 'Amount paid so far'; COMMENT ON COLUMN "invoices"."balance_due" IS 'Remaining balance'; COMMENT ON COLUMN "invoices"."period_start" IS 'Start date of the billing period (ISO format)'; COMMENT ON COLUMN "invoices"."billing_month" IS 'Billing month in YYYY-MM format'; COMMENT ON COLUMN "invoices"."period_end" IS 'End date of the billing period (ISO format)'; COMMENT ON COLUMN "invoices"."status" IS 'Current status of the invoice'; COMMENT ON COLUMN "invoices"."notes" IS 'Additional notes for the invoice'; COMMENT ON COLUMN "invoices"."terms" IS 'Terms and conditions for the invoice'; COMMENT ON COLUMN "invoices"."sent_at" IS 'When the invoice was sent to the customer'; COMMENT ON COLUMN "invoices"."paid_at" IS 'When the invoice was paid'; COMMENT ON COLUMN "invoices"."voided_at" IS 'When the invoice was marked as void'; COMMENT ON COLUMN "invoices"."metadata" IS 'Additional metadata for the invoice'; COMMENT ON COLUMN "invoices"."is_issued" IS 'Whether the invoice has been issued to the tenant'; COMMENT ON COLUMN "invoices"."items" IS 'Line items on this invoice'`);
        ...
        await queryRunner.query(`ALTER TABLE "invoices" ADD CONSTRAINT "FK_8f6204bf4a664d9909b07b07983" FOREIGN KEY ("portfolio_id") REFERENCES "portfolio"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "invoices" DROP CONSTRAINT "FK_8f6204bf4a664d9909b07b07983"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_8f6204bf4a664d9909b07b0798"`);
