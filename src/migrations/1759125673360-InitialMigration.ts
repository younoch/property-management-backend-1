...
export class InitialMigration1759125673360 implements MigrationInterface {
    name = 'InitialMigration1759125673360'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "phone" character varying, "password_hash" character varying NOT NULL, "role" character varying NOT NULL, "profile_image_url" character varying, "is_active" boolean NOT NULL DEFAULT true, "requires_onboarding" boolean NOT NULL DEFAULT true, "onboarding_completed_at" TIMESTAMP, "language" character varying(10) NOT NULL DEFAULT 'en', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "payment" ("id" SERIAL NOT NULL, "lease_id" integer NOT NULL, "amount" numeric(12,2) NOT NULL, "unapplied_amount" numeric(12,2) NOT NULL DEFAULT '0', "payment_method" "public"."payment_payment_method_enum" NOT NULL DEFAULT 'bank_transfer', "at" date NOT NULL, "reference" character varying, "notes" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_fcaec7df5adf9cac408c686b2ab" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "expenses" ("id" SERIAL NOT NULL, "property_id" integer NOT NULL, "amount" numeric(12,2) NOT NULL, "category" "public"."expenses_category_enum" NOT NULL DEFAULT 'other', "date_incurred" date NOT NULL, "date_recorded" date NOT NULL DEFAULT ('now'::text)::date, "status" "public"."expenses_status_enum" NOT NULL DEFAULT 'pending', "description" text, "vendor" character varying, "payment_method" "public"."expenses_payment_method_enum", "receipt_url" character varying, "tax_amount" numeric(12,2) NOT NULL DEFAULT '0', "tax_rate" numeric(5,2) NOT NULL DEFAULT '0', "notes" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_94c3ceb17e3140abc9282c20610" PRIMARY KEY ("id"))`);
